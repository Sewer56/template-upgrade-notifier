...
See the [examples folder](./examples) for a ready-to-use starting point, or the [library documentation](./src/template-upgrade-notifier/README.MD) for full configuration details.
